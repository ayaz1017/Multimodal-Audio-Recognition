  ...
  return (
    <div className="recognition-page">
      <div className="recognition-container">
        ...
        <p>Upload an audio file to analyze its features and get predictions</p>
        ...
        <div className="analysis-note-box">
          <label htmlFor="audio-notes">Clinical Note (optional)</label>
          <textarea
            id="audio-notes"
            placeholder="Add context for this analysis (symptoms, session notes, triggers)..."
            value={notes}
